...
public class TwitchStreamService : DataSource<TwitchStreamResult>
{
    ...
    public override func GetData(onComplete: (result : TwitchStreamResult) -> Void) {
        var target : String
